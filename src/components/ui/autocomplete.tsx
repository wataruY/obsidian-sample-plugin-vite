...
export default function Autocomplete({ value = '', onChange, fetchCandidates = fetchSuggestions, onSelect }: AutoCompleteProps) {
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLInputElement>) => {
    if (e.key === 'ArrowDown') {
      ...
      const queryResult = suggestions[selectedIndex]
      if (queryResult) {
        setQuery("")
        if (onSelect) {
